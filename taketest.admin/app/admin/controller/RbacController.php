...
class RbacController extends AdminBaseController
{
    ...
    public function authorize()
    {
        ...
        $str = "<tr id='node-\$id'\$parentIdNode  style='\$style'>
                   <td style='padding-left:30px;'>\$spacer<input lay-skin='primary' lay-filter='switchTest' type='checkbox' name='menuId[]' value='\$id' level='\$level' \$checked onclick='javascript:checknode(this);'> \$name</td>
    			</tr>";
        $tree->init($result);
